<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="aspResort.Categories" EnableEventValidation="false" %>
...
<body>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="Rooms.aspx">Rooms</a>
            ...
            <li class="nav-item">
          <a class="nav-link text-info" href="Categories.aspx">Categories</a>
        </li>
            <li class="nav-item">
  ...
  <div class="col-md-9">
                  ...
                  <asp:GridView ID="CategoriesGv" runat="server" class="table" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnSelectedIndexChanged="CategoriesGv_SelectedIndexChanged">
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:resortConnectionString %>" SelectCommand="SELECT [CatId], [Remarks], [CatName] FROM [Category]"></asp:SqlDataSource>
